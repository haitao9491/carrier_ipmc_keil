...
;//           <2=> 32 bit
;//       </h>
EMC_STA_CFG1_Val    EQU 0x00000080
...
;//           <i> The delay is in CCLK cycles
;//       </h>
EMC_STA_WWEN1_Val   EQU 0x00000002
...
;//           <i> The delay is in CCLK cycles
;//       </h>
EMC_STA_WOEN1_Val   EQU 0x00000002
...
;//           <i> The delay is in CCLK cycles
;//       </h>
EMC_STA_WWR1_Val    EQU  0x0000001E
...
;//           <2=> 32 bit
;//       </h>
EMC_STA_CFG2_Val    EQU 0x00000080
...
;//           <i> The delay is in CCLK cycles
;//       </h>
EMC_STA_WWEN2_Val   EQU 0x00000002
...
;//           <i> The delay is in CCLK cycles
;//       </h>
EMC_STA_WOEN2_Val   EQU 0x00000002
...
;//           <2=> 32 bit
;//       </h>
EMC_STA_CFG3_Val    EQU 0x00000081
...
;//           <i> The delay is in CCLK cycles
;//       </h>
EMC_STA_WWEN3_Val   EQU 0x00000002
...
;//           <i> The delay is in CCLK cycles
;//       </h>
EMC_STA_WOEN3_Val   EQU 0x00000002
...
Undef_Handler   B       OS_CPU_ARM_ExceptUndefInstrHndlr
SWI_Handler     B       OS_CPU_ARM_ExceptSwiHndlr
PAbt_Handler    B       OS_CPU_ARM_ExceptPrefetchAbortHndlr
DAbt_Handler    B       OS_CPU_ARM_ExceptDataAbortHndlr
IRQ_Handler     B       OS_CPU_ARM_ExceptIrqHndlr
FIQ_Handler     B       OS_CPU_ARM_ExceptFiqHndlr
...
;                MSR     CPSR_c, #Mode_USR
				msr     cpsr_c, #Mode_SVC:OR:F_Bit          ; Enable interrupts, if required                            ;
